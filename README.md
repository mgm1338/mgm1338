...
- Achieved 90%+ retention rates, outperforming peer teams by 20-30%
...
- Authentication systems at scale (SSO, OAuth, multi-factor authentication)
- Security audits and compliance (HIPAA, SOC 2)
- Zero-trust security architectures
- Authorization and access control for multi-tenant platforms
...
- Reduced query performance by 40-90% through optimization
...
- **Domains:** Identity/Auth, Platform Infrastructure, Healthcare (EHR, HIPAA), FinTech (Trading Systems)

---

## 💼 Professional Background

**Agero, Inc.** - Senior Engineering Manager (Nov 2024 - Present) | Remote
...
**Spring Health** - Associate Director of Software Engineering (Oct 2023 - Jul 2024) | Remote
...
**Spring Health** - Senior Software Engineering Manager (Aug 2021 - Oct 2023) | Remote
...
**Better.com** - Senior Software Engineering Manager (Jan 2021 - Jul 2021) | Remote
...
**Integral (Ford Autonomous Vehicle Lab)** - Software Engineering Manager (Sep 2019 - Jan 2021) | Remote
...
**CloakHire** - Founder & CTO (Jun 2016 - Mar 2020) | Remote
...
**Deutsche Bank** - Analyst → Associate, Software Development (Sep 2009 - Feb 2012) | New York
...
**UBS Investment Bank** - Software Engineering Consultant (Mar 2012 - Jul 2013) | New York
...
- Prior work at Deutsche Bank, UBS, Spring Health, Agero, and other companies cannot be open-sourced due to legal and business constraints
...
- Strong engineering culture = retention = outcomes
...
This GitHub profile emphasizes engineering leadership, architectural expertise, and problem-solving through descriptions of systems built, teams scaled, and business impact delivered. Due to non-compete agreements and proprietary work at previous employers (Deutsche Bank, UBS, Spring Health, Agero, and others), most of my professional projects remain private and cannot be shared publicly.
...
**Expertise:** Platform Engineering • Identity/Authentication • Healthcare Tech • FinTech • Distributed Systems • Team Leadership • HIPAA Compliance • High-Scale Systems
